        ...
        <div className="content">
          ...
          <div className="info">
            ...
            <div className="coin-price">
              {
                coin.market_data?.current_price ? <h1>
                PLN {coin.market_data.current_price.pln.toLocaleString()}
                </h1> : null
              }
            </div>
          </div>
              ...
              <tbody>
                <tr>
                  <td>
                    ...
                    <p>{coin.market_data.price_change_percentage_1h_in_currency.pln.toFixed(1)}</p>  
                  : null }
                  </td>
